...
private:
   FILE* mFile { nullptr };
   long mFaceIndex { 0 };
}; // class FileFontStream

// RAII Wrapper around FcPattern.
...
// Helper function to map FontWeight to Fontconfig weight.
...
// Helper function to map FontStyle to Fontconfig slant.
...
// Helper function to map FontStretch to Fontconfig width.
...
// Wrapper around libfontconfig library.
...
private:
   FcConfig* mFcConfig;
}; // class LinuxFontProvider::Fontconfig
