...
//! D2DBitmap implementation, that provides the best performance for the off-screen
//! rendering
...
private:
   ...
   Microsoft::WRL::ComPtr<ID2D1Bitmap> mLastPaintedBitmap;
   ID2D1RenderTarget* mLastPaintedRenderTarget { nullptr };
