...
struct GRAPHICS_API GraphicsDataCacheKey final
{
...
struct GRAPHICS_API GraphicsDataCacheElementBase /* not final */
{
...
class GRAPHICS_API GraphicsDataCacheBase /* not final */
{
public:
...
protected:
   ...
   struct GRAPHICS_API LookupElement final
   {
   ...
   struct GRAPHICS_API BaseLookupResult final
   {
...
public:
   ...
   using value_type = const CacheElementType;
...
private:
   ...
   std::deque<CacheElementType> mCache;
