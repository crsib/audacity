...
//! A class for 2D affine transformations. This class does not support rotations.
...
public:
   ...
   //! Returns true if scaling is not (1, 1).
   ...
   //! Applies the transform to a size.
   ...
   //! Translates copy of the transform.
   ...
   //! Transforms copy of the transformation.
   ...
   //! Returns true if the transform is singular.
   ...
   //! Inverses the transformation, if possible.
   ...
   //! Inverses copy of the transformation, if possible.
...
//! Alias for TransformType<float>.
using Transform = TransformType<float>;

//! A class for 2D affine transformations.
template <typename DataType>
class FullTransformType final
{
public:
   ...
   //! Translates copy of the transformation.
   ...
   //! Scales copy of the transformation.
   ...
   //! Return true if the transformation is singular.
   bool IsSingular() const noexcept
   {
   ...
   //! Inverses copy of the transformation.
