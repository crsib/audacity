...
//! Set of the ProgramConstants
/*!
 * This class should be used carefully with the PaintTarget class.
 * PaintTarget class deferrers rendering, so only the last applied
 * set of changes will be used
 */
